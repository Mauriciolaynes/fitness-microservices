package com.fitness.usuario.config;
...
/**
 * Resource Server: valida los tokens JWT emitidos por Keycloak.
 * Se utiliza un JwtDecoder personalizado basado en jwk-set-uri para evitar
